...
public class MachineExpandLvAdapter extends BaseExpandableListAdapter {
    ...
    // 设备的集合
    private List<MachineBean> mMachineBeen;
    ...
    public MachineExpandLvAdapter(List<MachineBean> mMachineBeen, Context context) {
        this.mMachineBeen = mMachineBeen;
        this.context = context;
    }

    @Override
    public int getGroupCount() {
        return mMachineBeen.size();
    }

    @Override
    public int getChildrenCount(int groupPosition) {
        // 获取对应一级条目下二级条目的数量
        return mMachineBeen.get(groupPosition).checkItems.size();
    }

    @Override
    public Object getGroup(int groupPosition) {
        // 获取一级条目的对应数据
        return mMachineBeen.get(groupPosition);
    }

    @Override
    public Object getChild(int groupPosition, int childPosition) {
        // 获取对应一级条目下二级条目的对应数据 感觉没什么用
        return mMachineBeen.get(groupPosition).checkItems.get(childPosition);
    }
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            mParentViewHolder = (MachineExpandLvAdapter.ParentViewHolder) convertView.getTag();//设置视图的标志位
        }
        // 绑定数据
        mParentViewHolder.ptv.setText(mMachineBeen.get(groupPosition).name);
        return convertView;
    }
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        MachineBean machineBean = mMachineBeen.get(groupPosition);
        mItemViewHolder.itv.setText(machineBean.checkItems.get(childPosition));
        return convertView;
    }
